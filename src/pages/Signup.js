    ...
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <form className="space-y-6" method="POST" onSubmit={handleSubmit(onSubmit)}>
            <TextInput register={register} required errors={errors} name="firstName" label={"First name"} placeholder="UMUHIRE" />
            <TextInput register={register} required errors={errors} name="lastName" label={"Last name"} placeholder="Heritier" />
