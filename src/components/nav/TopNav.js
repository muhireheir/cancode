                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            ...
                            <span  className="text-xl font-bold flex items-center lg:ml-2.5">
                                <img src="https://www.shecancodeschool.org/uploads/logos1.png" className=" h-8 mr-2" alt="Windster Logo" />
                                <span className="self-center whitespace-nowrap text-sm">Shecancode</span>
                            </span>
                        </div>
